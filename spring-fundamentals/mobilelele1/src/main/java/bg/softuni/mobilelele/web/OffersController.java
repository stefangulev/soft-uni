...
public class OffersController {
    ...
    public OffersController(OfferService offerService, ModelMapper modelMapper, CurrentUser currentUser, ModelRepository modelRepository) {
    ...
    public String postAddOffer(@Valid OfferCreateBindingModel offerCreateBindingModel, BindingResult bindingResult,
        ...
        serviceModel.setSellerId(currentUser.getId());
