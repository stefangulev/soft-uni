...
public class ContractController {
    //Controller methods should return Response entitites instead of booleans
    ...
    //endpoint should not contain actions (update,buy), bodies define the actions (two put mappings, but bodies differ)
    @PostMapping("/create")
