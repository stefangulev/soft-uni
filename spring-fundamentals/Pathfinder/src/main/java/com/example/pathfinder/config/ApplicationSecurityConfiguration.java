...
public class ApplicationSecurityConfiguration extends WebSecurityConfigurerAdapter {
    private final PathFinderUserService pathFinderUserService;
    private final PasswordEncoder passwordEncoder;

    public ApplicationSecurityConfiguration(PathFinderUserService pathFinderUserService, PasswordEncoder passwordEncoder) {
        this.pathFinderUserService = pathFinderUserService;
        this.passwordEncoder = passwordEncoder;
    }

    @Override
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(pathFinderUserService).passwordEncoder(passwordEncoder);
    }
