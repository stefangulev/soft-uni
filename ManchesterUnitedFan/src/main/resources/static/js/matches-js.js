    ...
    .then(info => {
        ...
        for (const infoElement of matches) {
            ...
            let card =
                ...
                '<img ' + 'src="/images/' + homeTeamImgName + '" ' + 'style="display: inline-block" width="100px" height="100px">' +
                '<h2 style="display: inline-block">' + homeTeamScore + '</h2>' +
                '<h2 style="display: inline-block">' + ' : ' + '</h2>' +
                '<h2 style="display: inline-block">' + awayTeamScore + '</h2>' +
                '<img ' + 'src="/images/' + awayTeamImgName + '" style="display: inline-block" width="100px" height="100px">' +
